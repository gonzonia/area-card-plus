 ...
 */
const ot = globalThis, Pt = ot.ShadowRoot && (ot.ShadyCSS === void 0 || ot.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Tt = Symbol(), t1 = /* @__PURE__ */ new WeakMap();
let Cs = class {
  constructor(e, s, i) {
...
const Os = (t) => new Cs(typeof t == "string" ? t : t + "", void 0, Tt), Se = (t, ...e) => {
  const s = t.length === 1 ? t[0] : e.reduce(((i, o, n) => i + ((r) => {
    if (r._$cssResult$ === !0) return r.cssText;
    if (typeof r == "number") return r;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(o) + t[n + 1]), t[0]);
  return new Cs(s, t, Tt);
}, ks = (t, e) => {
  if (Pt) t.adoptedStyleSheets = e.map(((s) => s instanceof CSSStyleSheet ? s : s.styleSheet));
...
}, s1 = Pt ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let s = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ds, defineProperty: Is, getOwnPropertyDescriptor: zs, getOwnPropertyNames: Ps, getOwnPropertySymbols: Ts, getPrototypeOf: Zs } = Object, ue = globalThis, i1 = ue.trustedTypes, Ns = i1 ? i1.emptyScript : "", ft = ue.reactiveElementPolyfillSupport, Pe = (t, e) => t, rt = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Ns : null;
      break;
  ...
  return s;
} }, Zt = (t, e) => !Ds(t, e), o1 = { attribute: !0, type: String, converter: rt, reflect: !1, useDefault: !1, hasChanged: Zt };
...
let Me = class extends HTMLElement {
  ...
  static createProperty(e, s = o1) {
    if (s.state && (s.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((s = Object.create(s)).wrapped = !0), this.elementProperties.set(e, s), !s.noAccessor) {
      ...
      o !== void 0 && Is(this.prototype, e, o);
    }
  }
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Pe("properties"))) {
      const s = this.properties, i = [...Ps(s), ...Ts(s)];
...
Me.elementStyles = [], Me.shadowRootOptions = { mode: "open" }, Me[Pe("elementProperties")] = /* @__PURE__ */ new Map(), Me[Pe("finalized")] = /* @__PURE__ */ new Map(), ft == null || ft({ ReactiveElement: Me }), (ue.reactiveElementVersions ?? (ue.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Te = globalThis, ct = Te.trustedTypes, n1 = ct ? ct.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, ys = "$lit$", de = `lit$${Math.random().toFixed(9).slice(2)}$`, Ls = "?" + de, Bs = `<${Ls}>`, be = document, Be = () => be.createComment(""), Re = (t) => t === null || typeof t != "object" && typeof t != "function", Nt = Array.isArray, Rs = (t) => Nt(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", gt = `[ 	
\f\r]`, ze = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, a1 = /-->/g, r1 = />/g, ge = RegExp(`>|${gt}(?:([^\\s"'>=/]+)(${gt}*=${gt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), c1 = /'/g, l1 = /"/g, As = /^(?:script|style|textarea|title)$/i, Fs = (t) => (e, ...s) => ({ _$litType$: t, strings: e, values: s }), g = Fs(1), oe = Symbol.for("lit-noChange"), V = Symbol.for("lit-nothing"), h1 = /* @__PURE__ */ new WeakMap(), Le = be.createTreeWalker(be, 129);
function bs(t, e) {
...
const Us = (t, e) => {
  ...
  for (let a = 0; a < s; a++) {
    ...
    n += r === ze ? c + Bs : h >= 0 ? (i.push(l), c.slice(0, h) + ys + c.slice(h) + de + p) : c + de + (h === -2 ? a : p);
  }
...
class Fe {
  constructor({ strings: e, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, r = 0;
    const a = e.length - 1, c = this.parts, [l, d] = Us(e, s);
    ...
    for (; (o = Le.nextNode()) !== null && c.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(ys)) {
          ...
          c.push({ type: 1, index: n, name: m[2], strings: p, ctor: m[1] === "." ? Ws : m[1] === "?" ? Ks : m[1] === "@" ? Gs : pt }), o.removeAttribute(h);
...
function Ee(t, e, s = t, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== n && ((a = o == null ? void 0 : o._$AO) == null || a.call(o, !1), n === void 0 ? o = void 0 : (o = new n(t), o._$AT(t, s, i)), i !== void 0 ? (s._$Co ?? (s._$Co = []))[i] = o : s._$Cl = o), o !== void 0 && (e = Ee(t, o._$AS(t, e.values), o, i)), e;
}
let js = class {
  constructor(e, s) {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (r === c.index) {
        let l;
        c.type === 2 ? l = new Oe(n, n.nextSibling, this, e) : c.type === 1 ? l = new c.ctor(n, c.name, c.strings, this, e) : c.type === 6 && (l = new qs(n, this, e)), this._$AV.push(l), c = i[++a];
      }
...
class Oe {
  ...
  _$AI(e, s = this) {
    e = Ee(this, e, s), Re(e) ? e === V || e == null || e === "" ? (this._$AH !== V && this._$AR(), this._$AH = V) : e !== this._$AH && e !== oe && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Rs(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(s);
      ...
      const r = new js(o, this), a = r.u(this.options);
...
class pt {
  ...
  _$AI(e, s = this, i, o) {
    ...
    let r = !1;
    if (n === void 0) e = Ee(this, e, s, 0), r = !Re(e) || e !== this._$AH && e !== oe, r && (this._$AH = e);
    else {
      const a = e;
      let c, l;
      for (e = n[0], c = 0; c < n.length - 1; c++) l = Ee(this, a[i + c], s, c), l === oe && (l = this._$AH[c]), r || (r = !Re(l) || l !== this._$AH[c]), l === V ? e = V : e !== V && (e += (l ?? "") + n[c + 1]), this._$AH[c] = l;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
class Gs extends pt {
  ...
  _$AI(e, s = this) {
    if ((e = Ee(this, e, s, 0) ?? V) === oe) return;
...
const Ys = { I: Oe }, vt = Te.litHtmlPolyfillSupport;
vt == null || vt(Fe, Oe), (Te.litHtmlVersions ?? (Te.litHtmlVersions = [])).push("3.3.1");
const Hs = (t, e, s) => {
...
var vs;
ie._$litElement$ = !0, ie.finalized = !0, (vs = Ae.litElementHydrateSupport) == null || vs.call(Ae, { LitElement: ie });
const Ct = Ae.litElementPolyfillSupport;
Ct == null || Ct({ LitElement: ie });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xs = { attribute: !0, type: String, converter: rt, reflect: !1, hasChanged: Zt }, Js = (t = Xs, e, s) => {
...
function z(t) {
  return (e, s) => typeof s == "object" ? Js(t, e, s) : ((i, o, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Qs } = Ys, d1 = (t, e) => (t == null ? void 0 : t._$litType$) !== void 0, ei = (t) => {
  var e;
  return ((e = t == null ? void 0 : t._$litType$) == null ? void 0 : e.h) != null;
}, u1 = () => document.createComment(""), Ce = (t, e, s) => {
  var n;
  ...
  return s;
}, ve = (t, e, s = t) => (t._$AI(e, s), t), ti = {}, Mt = (t, e = ti) => t._$AH = e, wt = (t) => t._$AH, yt = (t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const p1 = (t) => ei(t) ? t._$litType$.h : t.strings, _1 = qe(class extends Ye {
  constructor(t) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vs = "important", ii = " !" + Vs, S = qe(class extends Ye {
  constructor(t) {
    var e;
  ...
  update(t, [e]) {
    ...
    for (const i in e) {
      ...
      if (o != null) {
        this.ft.add(i);
        const n = typeof o == "string" && o.endsWith(ii);
...
const m1 = (t, e, s) => {
  ...
  update(t, [e, s, i]) {
    ...
    else if (a[h] === r[p]) c[p] = ve(o[h], n[p]), h++, p++;
    else if (a[_] === r[m]) c[m] = ve(o[_], n[m]), _--, m--;
    else if (a[h] === r[m]) c[m] = ve(o[h], n[m]), Ce(t, c[m + 1], o[h]), h++, m--;
    else if (a[_] === r[p]) c[p] = ve(o[_], n[p]), Ce(t, o[h], o[_]), _--, p++;
    else if (l === void 0 && (l = m1(r, p, m), d = m1(a, h, _)), l.has(a[h])) if (l.has(a[_])) {
      const f = d.get(r[p]), u = f !== void 0 ? o[f] : null;
      if (u === null) {
        const v = Ce(t, o[h]);
        ve(v, n[p]), c[p] = v;
      } else c[p] = ve(u, n[p]), Ce(t, o[h], u), o[f] = null;
      p++;
    } else yt(o[_]), _--;
    else yt(o[h]), h++;
    for (; p <= m; ) {
...
const Ue = ["sensor"], je = ["binary_sensor"], We = ["cover"], dt = ["climate"], Ms = ["camera"], Ze = [
  ...
  alarm_control_panel: { on: ci, off: li },
  siren: { on: vi, off: b1 },
  lock: { on: N1, off: Z1 },
  light: { on: Wi, off: Ki },
  media_player: { on: Vi, off: $i },
  climate: { on: $o, off: Mo },
  humidifier: { on: ai, off: ri },
  switch: {
    on: Ht,
    off: Vt,
    switch: { on: Ht, off: Vt },
  ...
  binary_sensor: {
    ...
    off: bt,
    motion: { on: Ji, off: Qi },
    moisture: { on: Io, off: Po },
    window: { on: is, off: ss },
    door: { on: O1, off: S1 },
    lock: { on: N1, off: Z1 },
    presence: { on: Fi, off: Ri },
    occupancy: { on: fo, off: go },
    vibration: { on: Oo, off: ko },
    opening: { on: Lo, off: yo },
    ...
    running: { on: io, off: so },
    plug: { on: U1, off: j1 },
    power: { on: oo, off: bt },
    battery: { on: _i, off: pi },
    battery_charging: { on: mi, off: fi },
    gas: { on: Ti, off: Pi },
  ...
  person: { on: g1, off: v1 },
  device_tracker: { on: g1, off: v1 },
  valve: { on: Eo, off: X1 },
  water_heater: { on: zo, off: To },
  remote: { on: ro, off: co },
  update: { on: y1, off: L1 },
  ...
  scene: { on: eo, off: to },
  notifications: { on: gi, off: b1 },
  sensor: { on: z1, off: z1 },
  script: { on: G1, off: G1 },
  tags: { on: Y1, off: Y1 },
  select: { on: et, off: et },
  automation: { on: lo, off: ho },
  button: { on: ht, off: ht },
  number: { on: tt, off: tt },
  ...
  tts: { on: J1, off: Q1 },
  wake_word: { on: Yi, off: Xi },
  weather: { on: Zo, off: es },
  zone: { on: B1, off: R1 },
...
}, xs = (t, e, s) => e && e._parsedCss ? e._parsedCss : t ? ws(t, s) : {}, Ko = L(
  (t, e, s, i, o) => {
    const n = {
...
`, te = [
  ...
  "not_home",
  "disarmed"
], qo = "unavailable", Yo = "unknown", ae = [qo, Yo], Xo = (t, e, s, i, o) => {
  var h, _, p, m, f;
  ...
  if (n && n !== "default" && ((_ = e == null ? void 0 : e.themes) != null && _[n])) {
    const { modes: u, ...v } = e.themes[n] || {};
    c = { ...c, ...v }, u && (r && u.dark ? c = { ...c, ...u.dark } : !r && u.light && (c = { ...c, ...u.light }));
  ...
  for (const [u, v] of Object.entries(c))
    t.style.setProperty(`--${u}`, String(v));
...
}, I = (t) => t.substr(0, t.indexOf(".")), Jo = (t) => (e, s) => t.includes(e, s), Rt = "unavailable", Qo = "unknown", en = "off", tn = [Rt, Qo], sn = Jo(tn), on = (t) => {
...
const os = /* @__PURE__ */ new Set([
  ...
  const o = [], n = an(s, "_"), r = i ? "active" : "inactive";
...
const pn = (t, e = 2) => Math.round(t * 10 ** e) / 10 ** e, _n = (t) => mn(t.attributes), mn = (t) => !!t.unit_of_measurement || !!t.state_class, fn = (t) => {
  ...
  return typeof t == "string" ? t : `${pn(t, s == null ? void 0 : s.maximumFractionDigits).toString()}${(s == null ? void 0 : s.style) === "currency" ? ` ${s.currency}` : ""}`;
}, rs = (t, e) => {
  const s = {
...
let it;
const Ln = async (t) => it || (it = t.callWS({
...
const $n = (t, e) => {
  ...
  try {
    const s = {
      ...
      entity: (o) => t.hass.states[o],
      callService: (o, n, r) => t.hass.callService(o, n, r),
      navigate: (o) => {
        window.history.pushState(null, "", o), window.dispatchEvent(new CustomEvent("location-changed"));
      },
      fireEvent: (o, n) => {
        t.dispatchEvent(new CustomEvent(o, { detail: n }));
      }
    };
    new Function(...Object.keys(s), e)(...Object.values(s));
  } catch (s) {
    console.error("Error executing custom action:", s), t.hass.callService("system_log", "write", {
      message: `Custom button action error: ${s.message}`,
      level: "error"
    });
  }
}, $t = (t, e) => {
  ...
  if (e === "custom_button" && (a == null ? void 0 : a.action) === "custom")
    try {
      $n(t, a.custom_code);
      return;
    } catch (_) {
      console.error("Error in custom button action:", _);
      return;
    }
  if (e === "domain") {
    ...
    if (_) {
      s === "media_player" ? t.hass.callService(
        s,
        t._isOn(s, void 0, t._getOrganizedEntities(
          t._getAreaEntityIds(
            t._config.area,
            t._devicesInArea(t._config.area, t.hass.devices),
            t.hass.entities,
            t._hiddenEntitiesSet,
            t._config.label
          ),
          t.hass.states,
          t._deviceClasses
...
const xe = L(
  ...
  if (!s || s.length === 0)
    return;
  let o;
  const n = s.filter((a) => !_n(a) || isNaN(Number(a.state)) ? !1 : o ? a.attributes.unit_of_measurement === o : (o = a.attributes.unit_of_measurement, !0));
  if (!n.length)
    return;
...
const _s = /* @__PURE__ */ new Set(), Sn = [ae, te], Ft = class Ft extends ie {
  constructor() {
  ...
  _getPopupCardConfig(e) {
    var p, m, f, u, v, $, H, C, y, w, A;
    const s = this.card, i = I(e.entity_id), o = this.selectedDomain || i, n = this.selectedDomain ? this.selectedDeviceClass : (u = (f = (m = (p = this.hass) == null ? void 0 : p.states) == null ? void 0 : m[e.entity_id]) == null ? void 0 : f.attributes) == null ? void 0 : u.device_class, r = (s == null ? void 0 : s._config) || {};
    let a;
    je.includes(o) ? (a = (v = r.customization_alert) == null ? void 0 : v.find(
      (b) => b.type === n
  ...
  sortEntitiesForPopup(e) {
    ...
    if (s === "state") {
      ...
      return i.sort((c, l) => {
        ...
        if (d !== h) return d - h;
        const _ = I(c.entity_id), p = I(l.entity_id), m = this.hass ? ds(this.hass, c.state, _) : c.state, f = this.hass ? ds(this.hass, l.state, p) : l.state, u = (m || "").localeCompare(f || "");
  ...
  render() {
    ...
    const l = (j = e._config) == null ? void 0 : j.hide_unavailable, d = (F = e._config) == null ? void 0 : F.category_filter, h = this.selectedDomain || null, _ = this.selectedDeviceClass || null, p = (E) => ye(E, this.hass.entities, d);
    let m = [];
    this.entities && this.entities.length > 0 ? m = this.entities.reduce((E, B) => {
      const R = B.entity_id;
      if (!p(R)) return E;
      const ne = I(R);
      return a.length > 0 && !a.includes(ne) || h && ne !== h || E.push(R), E;
    ...
    for (const E of c) {
      const B = I(E), R = r[E];
      R && (a.length > 0 && !a.includes(B) || h && B !== h || _ && R.attributes.device_class !== _ || p(E) && !f.some((ne) => ne.entity_id === E) && f.push(R));
    }
    const u = ((M = e == null ? void 0 : e._config) == null ? void 0 : M.ungroup_areas) === !0;
    let v = (O = e._config) != null && O.columns ? e._config.columns : 4, $ = [], H = [];
    if (u)
      H = this.sortEntitiesForPopup(f), v = Math.min(v, Math.max(1, H.length));
    else {
      const E = {};
      for (const K of f) {
        const Q = I(K.entity_id);
        Q in E || (E[Q] = []), E[Q].push(K);
      }
      const B = Object.keys(Ke || {}), R = a.length > 0 ? a : B;
      $ = Object.entries(E).filter(([K]) => !h || K === h).sort(([K], [Q]) => {
      ...
      v = Math.min(v, Math.max(1, ne));
    }
    if (this.style.setProperty("--columns", String(v)), !($.length > 0 || H.length > 0))
      return g`
        <ha-adaptive-dialog
          .hass=${this.hass}
          .open=${this.open}
      ...
      `;
    const y = ((k = e._area) == null ? void 0 : k.call(e, (P = e._config) == null ? void 0 : P.area, (T = e.hass) == null ? void 0 : T.areas)) ?? null;
    return g`
      <ha-adaptive-dialog
        .hass=${this.hass}
        .open=${this.open}
...
let ce = class extends ie {
  constructor() {
    super(...arguments), this.selectedDomain = null, this.selectedDeviceClass = null, this.selectedGroup = null, this._currentCameraIndex = 0, this._iconCache = /* @__PURE__ */ new Map(), this._styleCache = /* @__PURE__ */ new Map(), this._deviceClasses = xt, this._customizationDomainMap = /* @__PURE__ */ new Map(), this._customizationCoverMap = /* @__PURE__ */ new Map(), this._customizationAlertMap = /* @__PURE__ */ new Map(), this._customizationSensorMap = /* @__PURE__ */ new Map(), this._actionHandlerCache = /* @__PURE__ */ new Map(), this._hiddenEntitiesSet = /* @__PURE__ */ new Set(), this._excludedEntitiesSet = /* @__PURE__ */ new Set(), this._getAreaEntityIds = L(
      ...
      (t, e) => xe(t, e)
    ), this._computeCovers = Fo, this._computeAlerts = Uo, this._computeSensors = jo, this._computeButtons = Wo, this._computeIconStyles = L(
      (t, e, s, i) => Ko(
        t,
        e,
        s,
  ...
  updated(t) {
    ...
    (t.has("hass") && (!e || e.themes !== this.hass.themes) || t.has("_config") && (!s || s.theme !== this._config.theme)) && Xo(this, this.hass.themes, this._config.theme);
  }
  shouldUpdate(t) {
    var o, n;
  ...
  _executeCustomAction(t) {
    ...
    try {
      const e = {
        ...
        entity: (i) => this.hass.states[i],
        callService: (i, o, n) => this.hass.callService(i, o, n),
        navigate: (i) => {
          window.history.pushState(null, "", i), window.dispatchEvent(new CustomEvent("location-changed"));
        },
        fireEvent: (i, o) => {
  ...
  _renderCovers(t, e, s) {
    ...
    return g`
      ...
      ({ domain: a, deviceClass: c }) => {
        ...
        }), p = (l == null ? void 0 : l.color) || ((v = this._config) == null ? void 0 : v.cover_color), m = l == null ? void 0 : l.icon, f = _.length;
        return f > 0 ? g`
<div
class="icon-with-count hover"
style=${S(
          this._getParsedCss(
            (($ = l == null ? void 0 : l.styles) == null ? void 0 : $.button) || ((H = l == null ? void 0 : l.styles) == null ? void 0 : H.card) || ((C = this._config) == null ? void 0 : C.cover_css) || ((w = (y = this._config) == null ? void 0 : y.styles) == null ? void 0 : w.cover),
            l
          )
        )}
@action=${wn(this, a, c)}
  ...
  _renderAlerts(t, e, s) {
    ...
    return (r = this._config) != null && r.excluded_entities, g`
      ...
      ({ domain: a, deviceClass: c }) => {
        ...
        }), p = (l == null ? void 0 : l.color) || ((v = this._config) == null ? void 0 : v.alert_color), m = l == null ? void 0 : l.icon, f = _.length;
        return f > 0 ? g`
<div
class="icon-with-count hover"
style=${S(
          this._getParsedCss(
            (($ = l == null ? void 0 : l.styles) == null ? void 0 : $.button) || ((H = l == null ? void 0 : l.styles) == null ? void 0 : H.card) || ((C = this._config) == null ? void 0 : C.alert_css) || ((w = (y = this._config) == null ? void 0 : y.styles) == null ? void 0 : w.alert),
            l
          )
        )}
@action=${Mn(this, a, c)}
...
${(() => {
  ...
  renderCustomButtons(t) {
    ...
    return g`
      ...
      var h, _, p, m, f;
      if (n.conditional) {
        const u = n.entity ? I(n.entity) : null;
        if (u && u in t) {
          const v = t[u].find(
            ($) => $.entity_id === n.entity
          );
          if (!v || ae.includes(v.state) || te.includes(v.state))
            return V;
        }
      }
      let r;
      ...
      let a;
      n.activate_state_color && r && (!n.color || n.color === "state") && (a = un(r));
      const c = a ? { color: a } : n.color ? { color: `var(--${n.color}-color, ${n.color})` } : {};
      let l = n.icon;
      if (!l && r && (l = r.attributes.icon, !l)) {
        const u = I(r.entity_id), v = !ae.includes(r.state) && !te.includes(r.state);
        l = ps(u, v, r.attributes.device_class);
      }
      const d = !!n.name;
      return g`
            <div
...
${l ? l.startsWith("M") ? g`<ha-svg-icon
        ...
        ...this._getParsedCss(
          ...
          n
                    ...
                    ></ha-icon>` : V}
              ${d ? g`<span class="custom-button-label" style=${S({
        ...c,
  ...
  _renderButtons(t, e, s) {
    ...
    return (r = this._config) != null && r.excluded_entities, g`
      ...
      (a) => a,
      (a) => {
        var H, C, y, w, A, b, x, D, j, F;
        if (a === "climate") {
          const M = s.get("climate"), O = M == null ? void 0 : M.display_mode;
          if (M && M.hide === !0 || O !== "icon" && O !== "text_icon")
            return V;
        }
        const c = s.get(a), l = (c == null ? void 0 : c.color) || ((H = this._config) == null ? void 0 : H.domain_color), d = c == null ? void 0 : c.icon, h = a === "climate" ? (y = (C = this._config) == null ? void 0 : C.customization_domain) == null ? void 0 : y.find(
          (M) => M.type === "climate"
        ...
        if (m) {
          ...
          let M = !1, O = !1;
          for (const P of f) {
            const T = ((w = P.attributes) == null ? void 0 : w.hvac_action) ?? null, k = (P.state ?? "").toString().toLowerCase();
            if (T != null) {
          ...
          M ? v = this._getClimateColor("heat", "red") : O ? v = this._getClimateColor("cool", "cornflowerblue") : v = this._getClimateColor("standby", "") || ((A = this._config) == null ? void 0 : A.climate_standby_color);
        } else
          u = f.filter((M) => {
            var O;
            if (a === "climate") {
              const P = (O = M.attributes) == null ? void 0 : O.hvac_action;
              if (P != null) {
...
${(() => {
          var P, T;
          const M = d || this._cachedIcon(a, $ > 0), O = S({
            ...v ? { color: v } : {},
            ...!v && l ? { color: `var(--${l}-color)` } : {},
            ...!v && !l && ((P = this._config) != null && P.domain_color) ? { color: this._config.domain_color } : {},
            ...this._getParsedCss(
...
${(c = this._config) != null && c.wrap_sensor_icons ? se(
      ...
      ({ domain: l, deviceClass: d, index: h }) => {
        ...
        const f = m ? this.hass.states[m] : void 0, u = o.get(d), v = (u == null ? void 0 : u.color) || ((A = this._config) == null ? void 0 : A.sensor_color), $ = (u == null ? void 0 : u.invert) === !0, H = p.some(
          (k) => !ae.includes(k.state) && !te.includes(k.state)
        );
        if ($ && H)
          return V;
        const C = (b = this._config) != null && b.show_sensor_icons ? g`<ha-domain-icon
                      style=${S({
          ...v ? { color: `var(--${v}-color)` } : {},
          ...this._getParsedCss(
          ...
          ...this._getParsedCss(
            ...
            u
                ...
                >
                  ${!((P = this._config) != null && P.show_sensor_icons) && !((T = this._config) != null && T.wrap_sensor_icons) && h > 0 ? " - " : ""}
        ...
        return g`<div class="sensor-row off">${C}${y}</div>`;
      }
  ...
  _renderClimates(t, e, s) {
    ...
    return g`
      ...
      ({ domain: n }) => {
        ...
        const l = (r || []).filter((v) => {
          var A;
          const $ = (A = v.attributes) == null ? void 0 : A.hvac_action, H = v.state, C = !ae.includes(H) && !te.includes(H) && !i.includes(v.entity_id);
          if ($ != null) {
            const b = $.toString().toLowerCase();
            return C && (b !== "idle" && b !== "off");
          }
          const y = (H ?? "").toString().toLowerCase(), w = y.includes("heat") || y.includes("cool") || y !== "idle" && y !== "off";
          return C && w;
        }).map((v) => {
          var H, C, y, w;
          return `${((H = v.attributes) == null ? void 0 : H.temperature) ?? "N/A"} ${((w = (y = (C = this.hass) == null ? void 0 : C.config) == null ? void 0 : y.unit_system) == null ? void 0 : w.temperature) || ""}`;
        });
        if (l.length === 0)
          return V;
...
>(${l.join(", ")})</span
  ...
  render() {
    var P, T, k, N, E, B, R, ne, K, Q, ke, De, Ut, jt, Wt, Kt;
    if (!this._config || !this.hass || !this.hass.areas || !this.hass.devices || !this.hass.entities)
      return V;
    const t = ((P = this._config) == null ? void 0 : P.design) === "V2", e = t && ((T = this._config) != null && T.v2_color) ? `rgba(${this._config.v2_color.join(", ")})` : "var(--primary-color)", s = {
    ...
    let o = 3;
    try {
      const q = ((E = this.shadowRoot) == null ? void 0 : E.host) || document.documentElement, fe = getComputedStyle(q).getPropertyValue("--row-size");
...
>
${(() => {
      var q, fe, Je, Ie, Gt, qt, Yt, Xt, Jt, Qt, e1;
      if (!F) return V;
      if (A && D.length > 0) {
        ...
        if (_t === "split") {
          const Ve = ((Ie = this._config) == null ? void 0 : Ie.camera_entity_left) || ((Gt = D[0]) == null ? void 0 : Gt.entity_id), $e = ((qt = this._config) == null ? void 0 : qt.camera_entity_right) || ((Yt = D[1]) == null ? void 0 : Yt.entity_id);
          if (Ve && $e)
            return g`
                <div style="display: flex; height: 100%; width: 100%;">
                  <hui-image
                    style=${S({ flex: "1", width: "50%", "object-fit": "cover", ...mt })}
                    .config=${this._config}
                    .hass=${this.hass}
                    .cameraImage=${Ve}
          ...
          return _t === "single" && ((Jt = this._config) != null && Jt.camera_entity) ? Ve = this._config.camera_entity : _t === "auto" && D.length > 0 && (Ve = D[this._currentCameraIndex % D.length].entity_id), g`
              ${se([Ve], ($e) => $e, ($e) => g`
                <hui-image
                  .config=${this._config}
                  .hass=${this.hass}
                  style=${S({ width: "100%", height: "100%", ...mt })}
                  .cameraImage=${$e}
                  .cameraView=${this._config.camera_view}
                  fit-mode="cover"
                ></hui-image>
      ...
      if (b && _.picture)
        return g`
            <hui-image
              .config=${this._config}
              .hass=${this.hass}
              style=${S({ width: "100%", height: "100%", ...this._getParsedCss((e1 = (Qt = this._config) == null ? void 0 : Qt.styles) == null ? void 0 : e1.image, this._config) })}
              .image=${_.picture}
              fit-mode="cover"
            ></hui-image>
          `;
...
const Dn = L(() => [{ name: "area", selector: { area: {} } }]), In = L(
  (t, e, s, i, o) => {
...
W([
  z({ attribute: !1 })
], It.prototype, "customization_sensor", 2);
It = W([
...
let G = class extends ie {
    ...
    super(...arguments), this._activeTab = "config", this._subElementEditorDomain = void 0, this._subElementEditorAlert = void 0, this._subElementEditorCover = void 0, this._subElementEditorSensor = void 0, this._subElementEditorCustomButton = void 0, this._computeLabelCallback = L(
      ...
      (t, e, s) => {
        ...
        return Ne(
          ...
          void 0,
          i
        ).filter((r) => I(r) === "camera").map((r) => ({
          value: r,
          label: St(this.hass.states, r)
        }));
      }
      ...
      if (t.has("_config")) {
        ...
        if (i !== void 0 && i !== o) {
          const h = this._toggleDomainsForArea(
            ...
            (H, C) => Ze.indexOf(H) - Ze.indexOf(C)
          ), u = Object.keys(Ke || {}), v = new Map(
            u.map((H, C) => [H, C])
          ), $ = m.sort((H, C) => {
            const y = v.has(H) ? v.get(H) : Number.MAX_SAFE_INTEGER, w = v.has(C) ? v.get(C) : Number.MAX_SAFE_INTEGER;
            return y === w ? H.localeCompare(C) : y - w;
          });
          if (this._config.toggle_domains = [
            ...
            const H = this._config.hidden_entities, C = Object.values(this._hiddenEntitiesByDomain()).flat(), y = H.filter((w) => C.includes(w));
  ...
  _updateEntityOptions() {
    ...
    this._entityOptions = i.filter((n) => {
      var a;
      return this.hass.states[n] ? !((a = this.hass.entities[n]) != null && a.hidden) && e.includes(I(n)) : !1;
    }).map((n) => ({
      value: n,
      label: n
    }));
  ...
  _hiddenEntitiesByDomain() {
    ...
    const s = ((_ = this.hass) == null ? void 0 : _.entities) || {}, i = ((p = this.hass) == null ? void 0 : p.devices) || {}, o = (m = this.hass) != null && m.areas ? Object.values(this.hass.areas) : [], n = (f = this._config) == null ? void 0 : f.area, r = (u = this._config) == null ? void 0 : u.floor, a = (v = this._config) == null ? void 0 : v.label, c = n ? Array.isArray(n) ? n : [n] : [], l = r ? Array.isArray(r) ? r : [r] : [], d = a ? Array.isArray(a) ? a : [a] : [];
    for (const $ of e) {
      const H = I($), C = s[$], y = C != null && C.device_id ? i[C.device_id] : void 0;
      if (((C == null ? void 0 : C.area_id) != null || (y == null ? void 0 : y.area_id) != null) && !(d.length && !(Array.isArray(C == null ? void 0 : C.labels) && C.labels.some((b) => d.includes(b)) || Array.isArray(y == null ? void 0 : y.labels) && y.labels.some((b) => d.includes(b)))) && !(c.length && !(C != null && C.area_id && c.includes(C.area_id) || y != null && y.area_id && c.includes(y.area_id)))) {
        if (l.length) {
            ...
            return g`
                                            <div class="entity-row">
                                              <span class="entity-name">
                                                ${((v = (u = this.hass.states[f]) == null ? void 0 : u.attributes) == null ? void 0 : v.friendly_name) || f}
                                              </span>
                                              <ha-icon-button
        ...
        (m) => {
          ...
          return g`
            ...
            "ui.common.hide"
                                      ...
                                      ></ha-icon-button>
                                      <ha-icon-button
                                        .path=${this._isExcludedEntity(m) ? D1 : I1}
